...
namespace Assets.Code.UnityBehaviours
{
	...
	public class StateMaster : MonoBehaviour
	{
      ...
      //      AssetDatabase.Refresh();
			...
			//initialize pirate generator
			pirateGenerator.Initialize(_resolver);
			_resolver.RegisterItem(pirateGenerator);
			...
			List<PirateModel> piratesGeneratedByBuilding = new List<PirateModel> ();
			
			piratesGeneratedByBuilding.Add (_gameDataProvider.GetData<PirateModel> ("Gunner"));
			piratesGeneratedByBuilding.Add (_gameDataProvider.GetData<PirateModel> ("Bomber"));
			...
			_gameDataProvider.AddData (new BuildingModel
				...
				Descipriton = "Archer Towers are extremely versatile structures."+ 
					"They are able to target both Ground and Air Units,"+
						...
						piratesContained = piratesGeneratedByBuilding
			});
